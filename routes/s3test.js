var
    ...
    aws = require("aws-sdk"),
    clientSecretKey ='AKIAJLLTRF7OZTQ72NVA',

    // Set these two values to match your environment
    expectedBucket = "ziggy-upload-test",
    expectedHostname = "ziggy-upload-test.s3.eu-west-2.amazonaws.com",
...
// You will need to adjust these paths/conditions based on your setup.
    app.post("/api/s3handler", function (req, res) {
